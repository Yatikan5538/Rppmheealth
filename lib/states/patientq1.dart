...
class patientq1 extends StatefulWidget {
  const patientq1({Key? key}) : super(key: key);
  static const String title = 'แบบประเมินครั้งที่ 1';

  @override
  State<patientq1> createState() => _patientq1State();
}

class _patientq1State extends State<patientq1> {
  int? scoreValue;
  bool isStrechedDropdown = false;
  final List<String> data = ['ไม่ได้คุม','กินยาคุม','ยาเม็ดคุมกำเนิด','ยาฉีดคุมกำเนิด','ยาฝังคุมกำเนิด','ห่วงอนามัย','ถุงยางอนามัย','ทำหมันชาย','ทำหมันหญิง'];
