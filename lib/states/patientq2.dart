...
class patientq2 extends StatefulWidget {
  const patientq2({Key? key}) : super(key: key);
  static const String title = 'แบบประเมินครั้งที่ 2';

  @override
  State<patientq2> createState() => _patientq2State();
}

class _patientq2State extends State<patientq2> {
  int? scoreValue;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('แบบประเมินครั้งที่ 2'),
