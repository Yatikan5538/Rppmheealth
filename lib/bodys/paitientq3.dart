...
class patientq3 extends StatefulWidget {
  const patientq3({Key? key}) : super(key: key);
  static const String title = 'แบบประเมินครั้งที่ 3';

  @override
  State<patientq3> createState() => _patientq3State();
}

class _patientq3State extends State<patientq3> {
   int? scoreValue11;
  int? scoreValue12;
  int? scoreValue13;
  int? scoreValue14;
 ...
 String? selectedItemcontraceptive = 'วิธีคุมกำเนิด';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('แบบประเมินครั้งที่ 3'),
